...
st.set_page_config(page_title="LLaMA2 Chatbot by a16z-infra", page_icon=":left_speech_bubble:", layout="wide")

# Global variables
REPLICATE_API_TOKEN = os.environ.get('REPLICATE_API_TOKEN', default='')
REPLICATE_MODEL_ENDPOINTS = {
    'LLaMA2-7B': os.environ.get('REPLICATE_MODEL_ENDPOINT7B', default=''),
    'LLaMA2-13B': os.environ.get('REPLICATE_MODEL_ENDPOINT13B', default=''),
    'LLaMA2-70B': os.environ.get('REPLICATE_MODEL_ENDPOINT70B', default='')
}
...
def render_app():
    ...
    if 'llm' not in st.session_state:
        ...
        st.session_state['llm'] = REPLICATE_MODEL_ENDPOINTS['LLaMA2-70B']
    ...
    if selected_option == 'LLaMA2-7B':
        st.session_state['llm'] = REPLICATE_MODEL_ENDPOINTS['LLaMA2-7B']
    elif selected_option == 'LLaMA2-13B':
        st.session_state['llm'] = REPLICATE_MODEL_ENDPOINTS['LLaMA2-13B']
    else:
        st.session_state['llm'] = REPLICATE_MODEL_ENDPOINTS['LLaMA2-70B']
